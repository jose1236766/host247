        ...
        if (args[0]) {
            ...
            if (comando) {
                let embed = new Discord.EmbedBuilder()
                    ...
                    .setFooter({ text: `© desarrollado por jose1236766#2950 | 2022`, iconURL: `https://cdn.discordapp.com/avatars/282942681980862474/7ff4f4ae92af5feb0d258a71cdb0b060.png?size=4096` })
            ...
            .setColor(client.color)
            .setDescription(`Bot Multifuncional en desarrollo por \`jose1236766#2950\``)
            ...
            .addFields([{name: `📈 **__ESTADÍSTICAS__**`, value: `⚙ **${client.commands.size} Comandos**\n📁 en **${client.guilds.cache.size} Servidores**\n📶 **\`${client.ws.ping}ms\` Ping**\n👤 desarrollado por **[jose1236766#2950](https://discord.gg/JkmMQQgHEv)**`}], )
            .setThumbnail(message.guild.iconURL({ dynamic: true }))
            .setFooter({ text: `Página 1 / ${categorias.length+1}\n© desarrollado por jose1236766#2950 | 2022`, iconURL: `https://cdn.discordapp.com/avatars/282942681980862474/7ff4f4ae92af5feb0d258a71cdb0b060.png?size=4096` })
