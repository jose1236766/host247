...
module.exports = async (client, message) => {
    ...
    if(message.content.includes(client.user.id)) return message.reply({
        embeds: [
            ...
            .setFooter({text: `© desarrollado por jose1236766#2950 | 2022`, iconURL: `https://cdn.discordapp.com/avatars/282942681980862474/7ff4f4ae92af5feb0d258a71cdb0b060.png`})
